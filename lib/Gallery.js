        ...
        value: function render() {
            ...
            var images = this.state.thumbnails.map(function (item, idx) {
                return _react2.default.createElement(_Image2.default, {
                    ...
                    handleImageLoaded: _this2.props.handleImageLoaded,
                    handleImageErrored: _this2.props.handleImageErrored,
...
Gallery.propTypes = {
    ...
    handleImageLoaded: _propTypes2.default.func,
    handleImageErrored: _propTypes2.default.func
};
